...
typedef enum
{
	...
	DNSSD_ERROR_NOT_INITIALIZED = TIZEN_ERROR_DNSSD | 0x00FEFFF7,  /**< Not Initialized */
	DNSSD_ERROR_ALREADY_REGISTERED = TIZEN_ERROR_DNSSD | 0x00FEFFF5,  /**< Already registered */
	DNSSD_ERROR_NAME_CONFLICT = TIZEN_ERROR_DNSSD | 0x00FEFFF4,  /**< Name conflict */
	DNSSD_ERROR_SERVICE_NOT_RUNNING = TIZEN_ERROR_DNSSD | 0x00FEFFE5,  /**< Background daemon not running */
	DNSSD_ERROR_SERVICE_NOT_FOUND = TIZEN_ERROR_DNSSD | 0x00FEFFE0,  /**<  Service not found */
	DNSSD_ERROR_OPERATION_FAILED = TIZEN_ERROR_DNSSD | 0x00FEFFDF,  /**< Operation failed */
} dnssd_error_e;
 ...
 *          dnssd_service_add_txt_record_value() and then obtained using
 *          dnssd_service_get_txt_record_value() to pass here.
 * @since_tizen 3.0
 * @remarks You must pass only local services created using dnssd_create_local_service().
 * @param[in] local_service The DNSSD local service handle
