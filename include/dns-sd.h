 ...
 * @param[in] value_length The length of the value of the TXT record. The total
 *            size of a typical DNS-SD TXT record is intended to be small(upto
 *            200 bytes). For details see section 6.2 of
...
int dnssd_service_set_txt_record_value(dnssd_service_h local_service,
		const char *key, unsigned short value_length,
		const void *value);
 ...
 * @retval #DNSSD_ERROR_PERMISSION_DENIED Permission Denied
 * @see dnssd_create_local_service()
 * @see dnssd_service_set_txt_record_value()
 */
int dnssd_service_unset_txt_record_value(dnssd_service_h local_service,
		const char *key);

/**
 * @brief Adds the DNS resource record.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/nsd
 * @remarks You must pass only local services created using dnssd_create_local_service().
 ...
 * @param[in] length The length of the resource record
 ...
 * @see dnssd_create_local_service()
 */
int dnssd_service_add_record(dnssd_service_h local_service, unsigned short type,
 ...
 * @see dnssd_create_local_service()
 */
int dnssd_service_remove_record(dnssd_service_h local_service,
		unsigned short type);

/**
 * @brief Updates the DNS resource record.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/nsd
 * @remarks You must pass only local services created using dnssd_create_local_service().
 ...
 * @see dnssd_create_local_service()
 */
int dnssd_service_update_record(dnssd_service_h local_service,
 ...
 *          service_type provided in the argument.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/nsd
 ...
 * @privilege http://tizen.org/privilege/nsd
 * @param[in] dnssd_service The DNSSD local/remote service handle
 * @param[out] value_length The length of the value of the TXT record.
...
int dnssd_service_get_txt_record_value(dnssd_service_h dnssd_service,
		unsigned short *value_length, const void **value);
