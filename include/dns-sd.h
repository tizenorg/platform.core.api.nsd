 ...
 * @param[in] length The length of the value of the TXT record. The total size
 *            of a typical DNS-SD TXT record is intended to be small(upto 200
 *            bytes). For details see section 6.2 of
 ...
 *          dnssd_stop_browsing_service CAPI.
 * @since_tizen 3.0
 * @privlevel public
 * @privilege http://tizen.org/privilege/nsd
 ...
 * @privilege http://tizen.org/privilege/nsd
 * @param[in] dnssd_service The DNSSD local/remote service handle
 * @param[out] length The length of the value of the TXT record.
...
int dnssd_service_get_txt_record_value(dnssd_service_h dnssd_service,
		unsigned short *length, const void **value);
