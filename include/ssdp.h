...
int ssdp_get_found_target(ssdp_service_h ssdp_service, char **target);
int ssdp_get_found_usn(ssdp_service_h ssdp_service, char **usn);
int ssdp_get_found_url(ssdp_service_h ssdp_service, char **url);
